...
class DataTypeTest extends \PHPUnit\Framework\TestCase {
    ...
    public function testValidate() {
        ...
        $validator = new DataType('123.2', [DataType::OPTION_DATA_TYPE => 'numeric']);
        $this->assertTrue($validator->validate());

        $validator = new DataType('123', [DataType::OPTION_DATA_TYPE => 'numeric']);
        $this->assertTrue($validator->validate());

        $validator = new DataType(456, [DataType::OPTION_DATA_TYPE => 'numeric']);
        $this->assertTrue($validator->validate());
    }
